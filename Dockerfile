...
COPY src ./src
# Le journal des versions part AVEC l'image : `copy-web.js` le range parmi les actifs, et
# l'application le sert sans jamais appeler GitHub. Sans cette ligne il n'entre pas dans
# le contexte de build, et la page « Nouveautes » repondait 404.
COPY CHANGELOG.md ./
