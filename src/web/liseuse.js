  ...
  function ouvrir({ identite, titre, oeuvre, titreOeuvre, couverture, famille, reprise, surFermeture,
    ...
    function corpsPosition() {
      ...
      return {
        ...
        tome: `epub:${identite}`,
        // LA LISTE REPREND L'IDENTITE ECRITE ICI, jamais celle de l'appelant. Un livre
        // entre sous `epub:<identite>` : declarer le `t1` que la fiche avait en tete
        // laisserait la pastille lue en pointille tout en en ajoutant une seconde.
        // Sans liste du tout, le favori reste a `tomes` vide et la pastille l'est aussi.
        tomes: [`epub:${identite}`],
