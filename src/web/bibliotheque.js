...
(function () {
  ...
  function carte(entree, rafraichir) {
    ...
    // LES NUMEROS NE SONT PAS DES TOMES : on ne peut pas dessiner une grille de 1 a N.
    // Un periodique n'a pas de dernier numero connu, et il en parait un chaque semaine —
    // « ca fait BEAUCOUP de tome pour un magazine/journal ». La grille ci-dessous montre
    // donc ce qu'on a LU, et ce bouton va demander aux sources ce qui EXISTE.
    //
