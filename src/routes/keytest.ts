...
async function testerRustatio(cle: string): Promise<Verdict> {
  ...
  // MEME GARDE QUE L'APPEL REEL. Sans elle, « Tester mes cles » devenait un scanner du
  // reseau interne : le verdict rend le code HTTP exact, ce qui distingue « rien n'ecoute »
  // de « quelque chose ecoute et repond 401 ». Un oracle, offert a tout compte connecte.
