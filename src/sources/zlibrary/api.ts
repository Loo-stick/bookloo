...
/**
 * Une erreur destinee a l'utilisateur, avec le statut qui lui convient.
 *
 * LE STATUT COMPTE AUTANT QUE LE MESSAGE. Tout echec de lecture rendait un 502, qui dit
 * « le service distant a echoue » — et envoie donc chercher la cause chez lui. Or
 * « aucun fichier demande » est une erreur de NOTRE contrat : un 400. Signale a l'usage,
 * ou un « erreur 502 » a fait suspecter le site pendant que le defaut etait chez nous.
 */
