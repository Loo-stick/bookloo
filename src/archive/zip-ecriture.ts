 ...
 *
 * Vrai des qu'un fichier ou l'archive entiere approche 4 Go. La comparaison porte sur la
 * somme des donnees plus une marge large pour les en-tetes : etre trop prudent ne coute
 * que quelques dizaines d'octets, l'inverse produit une archive corrompue.
 */
