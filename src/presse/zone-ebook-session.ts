...
// TROISIEME COPIE DU MEME DOMAINE, trouvee en cherchant les deux premieres. Le module de
// session se connecte au site : il doit viser le meme que le kiosque et la source, sans
// quoi une correction de domaine laisserait la connexion sur l'ancien.
...
export async function connecter(
  ...
  const r = await postFormAvecCookies(`${BASE_()}/`, {
